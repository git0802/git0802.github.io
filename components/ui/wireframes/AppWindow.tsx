...
function AppWindow({
  ...
  return (
    <div
      role="presentation"
      className={clsx(
        "border-slate-200 pointer-events-none flex h-full w-full select-none flex-col overflow-hidden rounded-xl border bg-white",
        "dark:border-slate-800 dark:bg-[#0c1222]"
      )}
    >
      <div
        className={clsx(
          "border-slate-200 relative box-border border-b",
