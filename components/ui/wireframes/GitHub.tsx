...
import { SkeletonSm } from "@/components/ui/wireframes/Skeletons";
  ...
  return (
    ...
    >
      <div className={clsx("flex items-center gap-1")}>
        ...
        <div
          className={clsx(
            "border-slate-200 ml-1 rounded-full border px-2 py-0.5 text-xs",
      ...
      <div className={clsx("mt-6 flex gap-2")}>
        <div
          className={clsx(
            "border-slate-200 flex h-8 flex-1 items-center justify-center rounded-lg border",
            "dark:border-slate-800"
          )}
        >
          <div className={clsx("flex items-center gap-1")}>
      ...
      <div
        className={clsx(
          "border-slate-200 mt-4 flex border-b",
          "dark:border-slate-800"
        )}
      >
